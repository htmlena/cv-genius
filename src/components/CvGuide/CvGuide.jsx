      ...
      <div className="container-create-cv-guide">
        <div className="container-item">
          ...
          <div>
            <p>
              ...
              We highly recommend to include your LinkedIn URL with a completed
              profile and one more URL to present your project, website or
              github repositories. This way you can provide more information
          ...
          <p>
            ...
            recommend sticking to the point and taking into account the position
            and company you are applying to.
          </p>{' '}
          <div>
            ...
            <p className="resume-statement-example">
              ...
              and enrich their data with sales intelligence tools in Salesforce
              and Eloqua. Managing big data effectively, I have helped over 200
        ...
        <div className="container-item">
          ...
          <p>
            ...
            accordingly. Try to include them into your job description. If you
            are an experienced senior, we recommend you to include your last 3
            most relevant job experiences to a position you are applying for. If
            you are a student or just graduated, include also your internships
            or any activities during school (i.e. AIESEC). Include a description
            of your responsibilities and outputs you have achieved in the
            position.
          </p>
        </div>
        <div className="container-item">
          ...
          <p>
            ...
            long-period course, and you have an ambition to work in this field,
            we recommend that you include the course into the education section.
            Description of the studied courses is optional, but it provides you
            with another space for using the keywords which match the concrete
            job offer.
          </p>{' '}
        </div>
        <div className="container-item">
          ...
          <div>
            <p>
              ...
              but on the complex abilities of man. And the Hard skills: a set of
              professional requirements (theoretical knowledge, practical
          ...
          <p>
            ...
            list your soft skills. If you are looking for a job in Czech
            Republic, we recommend checking this list of skills listed by the
            central database of competencies.{' '}
          </p>
        </div>
        <div className="container-item">
          ...
          <p>
            ...
            are not sure about your level, you can test your approximate level
            by completing a verified test online which will allow you to
            estimate your abilities. Moreover, in case a language test would be
            a part of the recruitment process, your results will match your CV
            data.
          </p>
        </div>
        <div className="container-item">
